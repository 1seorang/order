...
//         <div>
//           <div>{audioVolume.padStart(3)}</div>
//           <Label>
//             <Image src="/assets/volume-bar.svg" alt="volume" />
//             <VolumeInputCanva>
//               <div>
//                 <VolumeRangeInput
//                   type="range"
...
//   &:active {
//     background-position: ${(props) => (props.audioEnabled ? "-48px" : "-144px")}
//       0;
//   }
// `;
    ...
    <>
      <Container>
        ...
        <div>
          <div>{audioVolume.padStart(3)}</div>
          <Label>
            <Image src="/assets/volume-bar.svg" width={19} height={12} alt="volume" />
            <VolumeInputCanva>
              <div>
                <VolumeRangeInput
                  type="range"
